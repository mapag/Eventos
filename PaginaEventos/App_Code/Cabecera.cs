...
public class Cabecera
{
    ...
    public string GenerarCabecera(string img_usuario, string nombre_usuario, int cant_notificaciones, int cant_invitaciones, int cant_novedades){
        String cabecera;
        cabecera = 
          "<header class='header dark-bg'>" +
            "<div class='toggle-nav'><div class='icon-reorder tooltips' data-original-title='Toggle Navigation' data-placement='bottom'><i class='icon_menu'></i></div></div>" +
            ...
            "<div class='top-nav notification-row'>" +
                "<ul class='nav pull-right top-menu'>" +
                    ...
                    "<li id='alert_notificatoin_bar' class='dropdown'>" +
                        "<a data-toggle='dropdown' class='dropdown-toggle' href='#'><i class='icon-bell-l'></i><span class='badge bg-important'>" + cant_notificaciones.ToString() + "</span></a>" +
                        "<ul class='dropdown-menu extended notification'>" +
                            "<div class='notify-arrow notify-arrow-blue'></div>" +
                            "<li><p class='blue'>Tiene " + cant_notificaciones + " notificaciones nuevas</p></li>" + 
